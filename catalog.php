...
<style>
    :root {
        font-family: 'Siemreap', 'Segoe UI', sans-serif; /* បន្ថែមត្រង់នេះ */
    ...
    /* ==========================================================================
       ១. រចនាបថ Menu Bar (Navigation Bar) ឱ្យមានលំនឹងថេរ និង Responsive
       ========================================================================== */
    .top-navbar {
        display: flex;
    ...
    .search-container input {
        ...
        border-radius: 30px; /* ធ្វើឱ្យរាងមូលស្អាតទំនើប */
        font-size: 14px;
        box-sizing: border-box;
        outline: none;
    ...
    /* ==========================================================================
       ៣. Responsive Design (កំណត់ទម្រង់សម្រាប់ Tablet និង Mobile Phone)
       ========================================================================== */
    ...
    @media (max-width: 992px) {
        ...
        .menu-toggle {
            display: block; /* បង្ហាញប៊ូតុង Hamburger */
            order: 3;
        }
        .nav-right-tools {
            order: 2;
        ...
        /* បំប្លែង Menu ឱ្យទៅជាទម្រង់ទម្លាក់ចុះក្រោមតាមបញ្ឈរ */
        .nav-menu {
            display: none;
            flex-direction: column;
            position: absolute;
        ...
        .nav-menu.show {
            display: flex; /* បង្ហាញនៅពេលចុច Toggle */
        }
        .nav-item {
            width: 100%;
        }
    ...
    @media (max-width: 600px) {
        ...
        .search-container {
            max-width: 100%; /* ប្រអប់ Search ពង្រីកពេញអេក្រង់ទូរស័ព្ទ */
        }
        .books-grid { 
            grid-template-columns: repeat(2, 1fr); /* បង្ហាញ ២ ក្បាលក្នុងមួយជួរលើទូរស័ព្ទ */
            gap: 12px;
        }
        .page-title {
            font-size: 22px;
        ...
        .search-mini-btn { display: none; } /* លាក់ប៊ូតុង Google តូចដើម្បីកុំឱ្យចង្អៀត */
    }
</style>
                    ...
                    <div style="margin-top: 10px;">
                        <?php if($b['status']==='Available' && $b['available_qty'] > 0): ?>
                            <a href="member/login.php?id=<?= $b['id'] ?>" 
                               style="display: block; width: 100%; text-align: center; font-size: 13px; font-weight: 600; color: #1a73e8; text-decoration: none; padding: 8px 0; border: 1px solid #1a73e8; border-radius: 4px; transition: background 0.2s;
                                font-family: 'Siemreap', sans-serif;">
                                ខ្ចីសៀវភៅ
                            </a>
                        <?php else: ?>
                            <button style="width: 100%; font-size: 13px; font-weight: 600; padding: 8px 0; background: #ffffff; color: #b0b0b0; border: 1px solid #e0e0e0; border-radius: 4px; cursor: not-allowed; text-align: center; 
                            font-family: 'Siemreap', sans-serif;" disabled>
                                អស់ពីស្តុក
                            </button>
                        <?php endif; ?>
                    </div>
...
<script>
    document.getElementById('mobile-menu-btn').addEventListener('click', function() {
        ...
        // ប្ដូររូបតំណាងពី ☰ ទៅជា ✕ ពេលបើក ឬ បិទ
